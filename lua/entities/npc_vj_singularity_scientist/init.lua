...
-----------------------------------------------*/
ENT.Model = {"models/singularity/scientist.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 110
...
ENT.VJ_NPC_Class = {"CLASS_SINGULARITYHUMAN","CLASS_PLAYER_ALLY"} -- NPCs with the same class with be allied to each other
...
ENT.Behavior = VJ_BEHAVIOR_PASSIVE -- Doesn't attack, but can attacked by others 
